      ...
      <div className="relative w-full max-w-md">
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to access SignalScope Dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" maxLength={72} required className="w-full pl-10 pr-12 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-600 focus:border-transparent transition-all" />
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-gray-400 cursor-pointer">
                <input type="checkbox" className="mr-2 w-4 h-4 rounded border-gray-700 bg-gray-800 text-pink-600 focus:ring-pink-600 focus:ring-offset-gray-900" />
                Remember me
              </label>
          ...
          <p className="text-center text-sm text-gray-400">
            ...
            <button onClick={onSwitchToRegister} className="text-pink-500 hover:text-pink-400 font-medium transition-colors">
              Sign up for free
            </button>
          </p>
        </div>
